...
class _DrawProgress extends CustomPainter{
  ...
  Paint progressPaint;
  Rect rect;
  _DrawProgress(this.color,this.radius,{double this.angle,AnimationController this.animation}){
...
class SkipDownTimeProgress extends StatefulWidget {
  ...
  @override
  createState ()=> SkipDownTimeProgressState();
}
class SkipDownTimeProgressState extends State<SkipDownTimeProgress> with TickerProviderStateMixin {
